...
/**
 * D5-inspired Lighting Enhancement Helper
 * Implements advanced lighting techniques within Three.js capabilities
 */
export class D5LightingEnhancements {
  ...
  private setupEnvironmentLighting(): void {
    ...
    hemiLight.name = 'd5-hemisphere-light';
